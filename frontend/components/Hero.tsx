      ...
      <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <h1 className="mx-auto max-w-4xl text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl leading-none">
          ...
          <div className="h-[1.4em] inline-flex items-center justify-center min-w-[280px] pb-2">
            <span className={`inline-block bg-gradient-to-r from-white via-slate-100 to-slate-200 bg-clip-text text-transparent transition-all duration-300 leading-normal pb-2 ${fadeState}`}>
        ...
        <div className="mt-10 flex justify-center">
          <a
            href="#generator"
            className="group relative inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-indigo-500/25 hover:scale-[1.02] focus:outline-none"
            style={{ paddingLeft: "2.5rem", paddingRight: "2.5rem", paddingTop: "1rem", paddingBottom: "1rem" }}
          >
