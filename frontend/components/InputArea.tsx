      ...
      >
        ...
        <div className="flex items-center justify-between border-t border-white/5 pt-3 px-3">
          ...
          <button
            ...
            className="group relative flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 via-indigo-600 to-purple-600 px-5.5 py-2.5 text-sm font-bold text-white shadow-[0_4px_15px_rgba(99,102,241,0.25)] transition-all hover:scale-[1.02] hover:shadow-[0_4px_20px_rgba(99,102,241,0.35)] focus:outline-none disabled:opacity-50 disabled:scale-100 disabled:shadow-none disabled:cursor-not-allowed"
          >
